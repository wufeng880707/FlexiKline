...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "indicatorSetting": MessageLookupByLibrary.simpleMessage(
      "Indicator settings",
    ),
    ...
    "mainChartIndicators": MessageLookupByLibrary.simpleMessage(
    ...
    "preferredIntervals": MessageLookupByLibrary.simpleMessage(
      "Preferred intervals",
    ),
    "reqMethodForbidden": MessageLookupByLibrary.simpleMessage(
      "Request method is forbidden",
    ),
    "responseTimeout": MessageLookupByLibrary.simpleMessage(
      "Server response timeout",
    ),
    "searchTradingPairHint": MessageLookupByLibrary.simpleMessage(
      "Please enter preferred trading pair",
    ),
    "selectTradingPair": MessageLookupByLibrary.simpleMessage(
      "Select Trading Pair",
    ),
    "sendTimeout": MessageLookupByLibrary.simpleMessage("Client send timeout"),
    "serverDown": MessageLookupByLibrary.simpleMessage("The server is down"),
    "serverInternalError": MessageLookupByLibrary.simpleMessage(
      "Server internal error",
    ),
    "serverRefused": MessageLookupByLibrary.simpleMessage(
    ...
    "subChartIndicators": MessageLookupByLibrary.simpleMessage(
      "Sub-chart indicators",
    ),
    "syntaxError": MessageLookupByLibrary.simpleMessage("Request syntax error"),
    ...
    "yAxisPriceScale": MessageLookupByLibrary.simpleMessage(
      "Price scale(y-axis)",
    ),
  };
}

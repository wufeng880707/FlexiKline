...
import 'common/text_arrow_button.dart';
...
class _FlexiKlineSettingBarState extends ConsumerState<FlexiKlineSettingBar> with WideScreenMixin {
  ...
  Future<void> onTapIndicatorSetting() async {
    ...
    await DialogManager().showBottomDialog(
      ...
      builder: (context) => IndicatorSelectDialog(controller: widget.controller),
    );
  ...
  void onTapKlineSetting() {
    SmartDialog.show(
      ...
      builder: (context) => KlineSettingDialog(controller: widget.controller),
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        Visibility(
          ...
          child: FlexiKlineDrawMenubar(controller: widget.controller),
        ),
      ],
    );
  }
          ...
          Expanded(
            child: ScrollConfiguration(
              ...
              child: SingleChildScrollView(
                ...
                //   onTapTimeBar: widget.onTapTimeBar,
                // ),
                child: _buildTimeBarList(context, timerBarList: showTimeBarList),
              ),
            ),
          ),
          Container(
...
class _TimeTabBarViewState extends ConsumerState<TimeBarTabBar>
  ...
  void initTabController() {
    ...
    _tabController = TabController(initialIndex: index, length: timerBarList.length, vsync: this);

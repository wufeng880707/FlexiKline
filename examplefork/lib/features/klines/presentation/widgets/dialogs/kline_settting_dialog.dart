...
class _KlineSettingDialogState extends ConsumerState<KlineSettingDialog> {
  ...
  Future<void> openLandscapePage() async {
    if (!DeviceUtil.isMobile) {
      SmartDialog.showToast('Landscape operation is not allowed on non-mobile devices');
      return;
    }

    SmartDialog.dismiss(tag: KlineSettingDialog.dialogTag);
    widget.controller.storeFlexiKlineConfig();
    final isUpdate = await ref
        .read(routerProvider)
        .pushNamed(
          'landscapeKline',
          extra: {
              ...
              Offstage(
                ...
                child: Visibility.maintain(
                  ...
                  child: Container(
                    ...
                    padding: EdgeInsetsDirectional.symmetric(horizontal: 8.r, vertical: 10.r),
  ...
  Widget _buildSettingTab(BuildContext context) {
    ...
    return Container(
      padding: EdgeInsetsDirectional.symmetric(horizontal: 16.r, vertical: 10.r),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(s.chartSettings, style: theme.t1s18w700),
          ...
          Row(
            ...
            children: [
              ...
              TextButton(
                style: theme.roundBtnStyle,
                onPressed: () {
                  ref.read(routerProvider).pushNamed('klineSetting', extra: widget.controller);
                },
                child: Column(
                  children: [
            ...
            children: [
              Expanded(
                child: CheckboxListTile(
                  ...
                  onChanged: (value) {
                    klineState.setShowLatestPrice(!klineState.isShowLatestPrice);
                  },
                  controlAffinity: ListTileControlAffinity.leading,
                  title: Text(s.lastPrice, style: theme.t1s14w500),
              ...
              Expanded(
                child: CheckboxListTile(
                  ...
                  controlAffinity: ListTileControlAffinity.leading,
                  title: Text(s.countdown, style: theme.t1s14w500),
                  activeColor: theme.t1,
                  selected: true,
                  checkColor: theme.themeColor,
                ),
            ...
            children: [
              Expanded(
                child: CheckboxListTile(
                  ...
                  contentPadding: EdgeInsets.zero,
                  onChanged: (value) {
                    klineState.setShowCandleHighPrice(!klineState.isShowCandleHighPrice);
                  },
                  controlAffinity: ListTileControlAffinity.leading,
                  title: Text(s.highPrice, style: theme.t1s14w500),
                  activeColor: theme.t1,
                  selected: true,
                  checkColor: theme.themeColor,
                ),
              ...
              Expanded(
                child: CheckboxListTile(
                  ...
                  contentPadding: EdgeInsets.zero,
                  onChanged: (value) {
                    klineState.setShowCandleLowPrice(!klineState.isShowCandleLowPrice);
                  },
                  controlAffinity: ListTileControlAffinity.leading,
                  title: Text(s.lowPrice, style: theme.t1s14w500),
                  activeColor: theme.t1,
                  selected: true,
                  checkColor: theme.themeColor,
                ),
            ...
            children: [
              Expanded(
                child: CheckboxListTile(
                  ...
                  controlAffinity: ListTileControlAffinity.leading,
                  title: Text(s.yAxisPriceScale, style: theme.t1s14w500),
                  activeColor: theme.t1,
                  selected: true,
                  checkColor: theme.themeColor,
                  // shape: theme.defaultShape,
  ...
  Widget _buildKlineWidthSetting(BuildContext context) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(s.chartWidth, style: theme.t1s14w400),
        FlexiKlineSizeSlider(
          controller: widget.controller,
          maxSize: Size(ScreenUtil().screenWidth, ScreenUtil().screenHeight * 2 / 3),
  ...
  Widget _buildKlineHeightSetting(BuildContext context) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(s.chartHeight, style: theme.t1s14w400),
        FlexiKlineSizeSlider(
          controller: widget.controller,
          maxSize: Size(ScreenUtil().screenWidth, ScreenUtil().screenHeight * 2 / 3),
          axis: Axis.vertical,

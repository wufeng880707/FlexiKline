...
class IndicatorSelectDialog extends ConsumerWidget {
  ...
  const IndicatorSelectDialog({super.key, required this.controller});
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(s.indicators, style: theme.t1s20w700),
            SizedBox(height: 20.r),
            Text(s.mainChartIndicators, style: theme.t1s16w500),
            SizedBox(height: 10.r),
            _buildMainIndicators(ref),
            SizedBox(height: 20.r),
            Text(s.subChartIndicators, style: theme.t1s16w500),
            SizedBox(height: 10.r),
            _buildSubIndicators(ref),
            SizedBox(height: 10.r),
            ListTile(
              contentPadding: EdgeInsets.zero,
              leading: Text(s.indicatorSetting, style: theme.t1s16w500),
              trailing: Icon(Icons.arrow_forward_ios, color: theme.t1, size: 16.r),
              onTap: () {
                // TODO:
              },
            ),

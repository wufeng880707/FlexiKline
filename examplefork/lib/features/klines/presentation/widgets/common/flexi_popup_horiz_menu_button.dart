...
class FlexiPopupHorizMenuButton<T> extends ConsumerWidget {
  ...
  Widget _buildMenuWidget(BuildContext context, WidgetRef ref) {
    if (showArrow) {
      ...
      return Container(
        constraints: constraints ?? BoxConstraints(minHeight: 32.r, minWidth: 32.r),
        child: Row(
            ...
            ValueListenableBuilder(
              ...
              builder: (context, value, child) {
                return RotationTransition(
                  ...
                  child: Icon(Icons.arrow_drop_down, size: 14.r, color: theme.t1),
    ...
    SmartDialog.showAttach(
      ...
      builder: (context) {
        return Container(
          ...
          decoration: BoxDecoration(color: theme.cardBg, borderRadius: BorderRadius.circular(6.r)),
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children:
                  ...
                  return IconButton(
                    ...
                    style: ButtonStyle(
                      ...
                      backgroundColor: WidgetStateProperty.all(
                        initialValue == item.value ? theme.gridLine : Colors.transparent,
                      ),
                    ),

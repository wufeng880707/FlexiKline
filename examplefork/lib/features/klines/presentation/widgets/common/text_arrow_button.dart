...
class TextArrowButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return InkWell(
      onTap: onPressed,
      child: Container(
        padding: EdgeInsetsDirectional.only(start: 2.r, end: 2.r, top: 4.r, bottom: 4.r),
        margin: EdgeInsetsDirectional.only(start: 6.r),
        alignment: AlignmentDirectional.center,
        decoration: BoxDecoration(color: background, borderRadius: BorderRadius.circular(5.r)),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text(text, style: textStyle ?? theme.t1s14w500),

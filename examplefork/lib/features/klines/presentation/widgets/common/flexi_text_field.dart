    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          border: border ?? genOutlineBorder(color: theme.borderLine, radius: defaultBorderRadius),

          ///设置输入框可编辑时的边框样式
          enabledBorder:
              enabledBorder ??
              genOutlineBorder(color: theme.borderLine, radius: defaultBorderRadius),

          ///设置输入框禁用时的边框样式
          disabledBorder:
              disabledBorder ?? genOutlineBorder(color: theme.disable, radius: defaultBorderRadius),

          ///用来配置输入框获取错误焦点时的颜色
          errorBorder:
              errorBorder ?? genOutlineBorder(color: theme.error, radius: defaultBorderRadius),

          ///用来配置输入框获取错误焦点时的颜色
          focusedErrorBorder:
              focusedErrorBorder ??
              genOutlineBorder(color: theme.error, radius: defaultBorderRadius),

          ///用来配置输入框获取焦点时的颜色
          focusedBorder:
              focusedBorder ?? genOutlineBorder(color: theme.t1, radius: defaultBorderRadius),
        ),
      ),
    );
  }
...
InputBorder genOutlineBorder({double? radius, required Color color, double? width}) {
  return OutlineInputBorder(
    borderRadius: BorderRadius.circular(radius ?? 6.r),
    borderSide: BorderSide(color: color, width: width ?? 1.r),
  );
}

...
class FlexiKlineDrawMenubar extends ConsumerStatefulWidget {
  const FlexiKlineDrawMenubar({super.key, required this.controller});
      ...
      child: Row(
        children: [
              ...
              child: SingleChildScrollView(
                ...
                child: ValueListenableBuilder(
                  ...
                  builder: (context, state, child) {
                    ...
                    return Row(
                      children:
                          widget.controller.supportDrawTypes.map((type) {
          ...
          ValueListenableBuilder(
            ...
            builder:
                (context, isOn, child) => ShrinkIconButton(
                  onPressed: () {
          ...
          ValueListenableBuilder(
            ...
            builder:
                (context, mode, child) => ShrinkIconButton(
                  onPressed: () {
          ...
          ValueListenableBuilder(
            ...
            builder:
                (context, isShow, child) => ShrinkIconButton(
                  onPressed: () {
          ...
          ShrinkIconButton(onPressed: () {}, content: Icons.login_rounded),
        ],
      ),
    );
  }

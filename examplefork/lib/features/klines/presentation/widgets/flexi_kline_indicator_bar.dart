...
class FlexiKlineIndicatorBar extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _FlexiKliineIndicatorBarState();
}

class _FlexiKliineIndicatorBarState extends ConsumerState<FlexiKlineIndicatorBar> {
  @override
  void initState() {
    super.initState();
  }
